...
Paste any Finnish text into the input field and click **Muunna**. The app sends the text to an AI model instructed to follow official Selkokeskus guidelines and returns a simplified version on the same page.
